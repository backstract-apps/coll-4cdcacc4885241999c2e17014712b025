...
app = FastAPI(title='Backstract Generated APIs - coll-4cdcacc4885241999c2e17014712b025', debug=False,
              docs_url='/admiring-buck-b24eed224b7011f0bf0fc229be215aa346/docs',
              openapi_url='/admiring-buck-b24eed224b7011f0bf0fc229be215aa346/openapi.json')
...
app.include_router(
    router,
    prefix='/admiring-buck-b24eed224b7011f0bf0fc229be215aa346/api',
    tags=['APIs v1']
)
